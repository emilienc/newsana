  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved target as @target" do
        ...
        post :create, {:target => { "user_id" => "invalid value" }}, valid_session
        assigns(:target).should be_a_new(Target)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested target" do
        ...
        Target.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => target.to_param, :target => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the target as @target" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Target.any_instance.stub(:save).and_return(false)
        put :update, {:id => target.to_param, :target => { "user_id" => "invalid value" }}, valid_session
        assigns(:target).should eq(target)
      end
